...
// gset.NewStrSet create and returns a new set, which contains un-repeated items.
// The parameter `safe` is used to specify whether using set in concurrent-safety,
// which is false in default.
func ExampleNewStrSet() {
	strSet := gset.NewSet[string](true)
...
// gset.NewStrSetFrom returns a new set from `items`.
...
func ExampleStrSet_Complement() {
	strSet := gset.NewFrom[string]([]string{"str1", "str2", "str3", "str4", "str5"}, true)
	s := gset.NewFrom[string]([]string{"str1", "str2", "str3"}, true)
...
func ExampleStrSet_Diff() {
	s1 := gset.NewFrom[string]([]string{"a", "b", "c"}, true)
	s2 := gset.NewFrom[string]([]string{"a", "b", "c", "d"}, true)
...
func ExampleStrSet_Equal() {
	...
	s3 := gset.NewFrom[string]([]string{"a", "b", "c"}, true)
	s4 := gset.NewFrom[string]([]string{"a", "b", "c"}, true)
...
func ExampleStrSet_MarshalJSON() {
	type Student struct {
		Id     int
		Name   string
		Scores *gset.HashSet[string]
	}
	s := Student{
		Id:     1,
		Name:   "john",
		Scores: gset.NewFrom[string]([]string{"100", "99", "98"}, true),
	}
	b, _ := json.Marshal(s)
