...
func TestStrSet_Equal(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		s1 := gset.NewSet[string]()
		s2 := gset.NewSet[string]()
		s3 := gset.NewSet[string]()
		s4 := gset.NewSet[string]()
		s1.Add("1", "2", "3")
		s2.Add("1", "2", "3")
		s3.Add("1", "2", "3", "4")
		s4.Add("4", "5", "6")
...
func TestNewIntSetFrom(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		s1 := gset.NewFrom[int]([]int{1, 2, 3, 4})
		s2 := gset.NewFrom[int]([]int{5, 6, 7, 8})
...
func TestStrSet_Sum(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		s1 := gset.NewFrom[string]([]string{"a", "b", "c"}, true)
		s2 := gset.NewFrom[int]([]int{2, 3, 4}, true)
		t.Assert(s1.Sum(), 0)
		t.Assert(s2.Sum(), 9)
	})
}
...
func TestStrSet_Json(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		s1 := []string{"a", "b", "d", "c"}
		a1 := gset.NewFrom[string](s1)
		b1, err1 := json.Marshal(a1)
		b2, err2 := json.Marshal(s1)
		t.Assert(len(b1), len(b2))
		t.Assert(err1, err2)

		a2 := gset.NewSet[string]()
...
func TestStrSet_DeepCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		set := gset.NewSet[string]()
		set.Add("1", "2", "3")

		copySet := set.DeepCopy().(*gset.HashSet[string])
		copySet.Add("4")
