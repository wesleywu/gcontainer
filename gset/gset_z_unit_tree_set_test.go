...
func TestTreeSet_NewTreeSet(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		s := gset.NewTreeSet[int](comparator.ComparatorInt)
		s.Add(1, 1, 2)
		s.Add([]int{3, 4}...)
		t.Assert(s.Size(), 4)
...
func TestTreeSet_NewTreeSetFrom(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := gset.NewTreeSetFrom(a1, comparator.ComparatorString)
		array2 := gset.NewTreeSetFrom(a2, func2)
...
func TestTreeSet_Add(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		s := gset.NewTreeSetDefault[int](true)
		s.Add(1)
...
func TestTreeSet_AddAll(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		s := gset.NewTreeSetDefault[int](true)
		s.AddAll(gset.NewFrom([]int{3, 1, 2}))
		t.Assert(s.Add(1), false)
		t.Assert(s.Contains(1), true)
...
func TestTreeSet_ContainsAll(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		s := gset.NewTreeSetDefault[int](true)
		s.AddAll(gset.NewFrom([]int{3, 1, 2}))
		t.Assert(s.ContainsAll(gset.NewFrom([]int{1, 2, 3})), true)
		t.Assert(s.ContainsAll(gset.NewFrom([]int{1, 2})), true)
		t.Assert(s.ContainsAll(gset.NewFrom([]int{2, 3})), true)
		t.Assert(s.ContainsAll(gset.NewFrom([]int{2, 3, 4})), false)
		t.Assert(s.ContainsAll(gset.NewFrom([]int{4})), false)
	})
}

func TestTreeSet_DeepCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := gset.NewTreeSetFrom([]int{1, 2, 3, 4, 5}, comparator.ComparatorInt)
		copyArray := array.DeepCopy().(*gset.TreeSet[int])
		array.Add(6)
		copyArray.Add(7)
...
func TestTreeSet_Equals(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		s1 := gset.NewTreeSetDefault[int]()
		s2 := gset.NewTreeSetDefault[int]()
		s3 := gset.NewTreeSetDefault[int]()
		s4 := gset.NewTreeSetDefault[int]()
		s1.Add(1, 2, 3)
		s2.Add(1, 2, 3)
		s3.Add(1, 2, 3, 4)
		s4.Add(4, 5, 6)
...
func TestTreeSet_First(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		array := gset.NewTreeSetFrom[int]([]int{3, 1, 2}, comparator.ComparatorInt)
		v, ok := array.First()
		t.Assert(v, 1)
		t.Assert(ok, true)
	})
...
func TestTreeSet_ForEach(t *testing.T) {
	...
	treeSet := gset.NewTreeSetFrom(slice, comparator.ComparatorString)
	gtest.C(t, func(t *gtest.T) {
		index := 0
...
func TestTreeSet_IsEmpty(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := gset.NewTreeSetFrom([]string{}, comparator.ComparatorString)
...
func TestTreeSet_PollFirst(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		array := gset.NewTreeSetFrom[int]([]int{1, 2, 3}, comparator.ComparatorInt)
...
func TestTreeSet_RemoveAll(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		a1 := []string{"a", "d", "c", "b"}
		array1 := gset.NewTreeSetFrom(a1, comparator.ComparatorString)
		changed := array1.RemoveAll(gset.NewFrom([]string{"b"}))
		t.Assert(changed, true)
		t.Assert(array1.Size(), 3)
		t.Assert(array1.Contains("b"), false)

		changed = array1.RemoveAll(gset.NewFrom([]string{"e"}))
		t.Assert(changed, false)

		changed = array1.RemoveAll(gset.NewFrom([]string{"a", "d"}))
		t.Assert(changed, true)
		t.Assert(array1.Size(), 1)
		t.Assert(array1.Contains("a"), false)
		t.Assert(array1.Contains("d"), false)
		...
		changed = array1.RemoveAll(gset.NewFrom([]string{"a", "d", "c", "b"}))
		t.Assert(changed, true)
		t.Assert(array1.Size(), 0)
		t.Assert(array1.Contains("c"), false)
	})
...
func TestTreeSet_String(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array1 = gset.NewTreeSetDefault[int]()
		t.Assert(array1.String(), "[]")

		array2 := gset.NewTreeSetDefault[string]()
...
func TestTreeSet_SubSet(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		treeSet := gset.NewTreeSetFrom(m, comparator.ComparatorString)
...
func TestTreeSet_UnmarshalValue(t *testing.T) {
	type V struct {
		Name  string
		Array *gset.TreeSet[byte]
	}
	type VInt struct {
		Name  string
		Array *gset.TreeSet[int]
	}
	// JSON
	gtest.C(t, func(t *gtest.T) {
		var v *V
