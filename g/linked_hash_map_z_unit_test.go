...
func Test_ListMap_Var(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		var m = g.NewListMap[string, string]()
		m.Put("key1", "val1")
...
func Test_ListMap_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		m2 := g.NewListMapFrom(map[interface{}]interface{}{1: 1, "key1": "val1"})
...
func Test_ListMap_Clone(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		// clone 方法是深克隆
		m := g.NewListMapFrom[string, string](map[string]string{"1": "1", "key1": "val1"})
		m_clone := m.Clone()
		m.Remove("1")
...
func Test_ListMap_Basic_Merge(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m1 := g.NewListMap[string, string]()
		m2 := g.NewListMap[string, string]()
		m1.Put("key1", "val1")
		m2.Put("key2", "val2")
		m1.Merge(m2)
		t.Assert(m1.Map(), map[interface{}]interface{}{"key1": "val1", "key2": "val2"})
		m3 := g.NewListMapFrom[string, string](nil)
		m3.Merge(m2)
...
func Test_ListMap_Json(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		m1 := g.NewListMapFrom[string, string](data)
	...
	gtest.C(t, func(t *gtest.T) {
		...
		var m g.LinkedHashMap[string, string]
		err = json.UnmarshalUseNumber(b, &m)
		t.AssertNil(err)
		t.Assert(m.Get("k1"), data["k1"])
		t.Assert(m.Get("k2"), data["k2"])
...
func Test_ListMap_Pop(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m := g.NewListMapFrom(map[string]string{
			"k1": "v1",
			"k2": "v2",
		})
		t.Assert(m.Size(), 2)
...
func TestListMap_UnmarshalValue(t *testing.T) {
	type V struct {
		Name string
		Map  *g.LinkedHashMap[string, string]
	}
	// JSON
	gtest.C(t, func(t *gtest.T) {
		var v *V
...
func TestListMap_String(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m := g.NewListMap[int, string]()
		m.Put(1, "")
		m.Put(2, "2")
		t.Assert(m.String(), "{\"1\":\"\",\"2\":\"2\"}")

		m1 := g.NewListMapFrom[int, string](nil)
		t.Assert(m1.String(), "{}")
	})
}
...
func TestListMap_DeepCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		n := m.DeepCopy().(*g.LinkedHashMap[int, string])
		n.Put(1, "val1")
