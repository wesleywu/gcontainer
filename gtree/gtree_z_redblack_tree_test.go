...
func Test_RedBlackTree_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m := gtree.NewRedBlackTree[string, string](comparator.ComparatorString)
		m.Put("key1", "val1")
		...
		m2 := gtree.NewRedBlackTreeFrom(comparator.ComparatorString, map[string]string{"1": "1", "key1": "val1"})
...
func Test_RedBlackTree_Set_Fun(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		m := gtree.NewRedBlackTree[string, int](comparator.ComparatorString)
...
func Test_RedBlackTree_Iterator(t *testing.T) {
	...
	m := gtree.NewRedBlackTreeFrom[string, string](comparator.ComparatorString, expect)
...
func Test_RedBlackTree_Clone(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		//clone 方法是深克隆
		m := gtree.NewRedBlackTreeFrom[string, string](comparator.ComparatorString, map[string]string{"1": "1", "key1": "val1"})
		m_clone := m.Clone()
		m.Remove("1")
...
func Test_RedBlackTree_LRNode(t *testing.T) {
	...
	//unsafe
	gtest.C(t, func(t *gtest.T) {
		m := gtree.NewRedBlackTreeFrom[string, string](comparator.ComparatorString, expect, true)
		t.Assert(m.Left().Key, "key1")
		t.Assert(m.Right().Key, "key4")
	})
}
...
func Test_RedBlackTree_Remove(t *testing.T) {
	m := gtree.NewRedBlackTree[int, string](comparator.ComparatorInt)
	for i := 1; i <= 100; i++ {
