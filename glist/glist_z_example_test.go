...
func ExampleNewFrom() {
	n := 10
	l := glist.NewFrom[int](garray.NewArrayRange(1, 10, 1).Slice())
...
func ExampleList_PushFront() {
	l := glist.NewFrom[int](garray.NewArrayRange(1, 5, 1).Slice())
...
func ExampleList_Len() {
	l := glist.NewFrom[int]([]int{1, 2, 3, 4, 5})
...
func ExampleList_PushBackList() {
	...
	other := glist.NewFrom[int]([]int{6, 7, 8, 9, 10})
...
func ExampleList_PushFrontList() {
	...
	other := glist.NewFrom[int]([]int{-4, -3, -2, -1, 0})
