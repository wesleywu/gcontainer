...
func TestSortedArray_PopLeft(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		array := garray.NewSortedArrayFrom[int]([]int{1, 2, 3}, comparator.ComparatorInt)
		v, ok := array.PopLeft()
		t.Assert(v, 1)
		t.Assert(ok, true)
...
func TestSortedArray_Empty(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := garray.NewSortedArray[int](comparator.ComparatorInt)
		v, ok := array.PopLeft()
		t.Assert(v, 0)
		t.Assert(ok, false)
...
func TestSortedArray_Chunk(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		a1 := []int{1, 2, 3, 4, 5}
		array1 := garray.NewSortedArrayFrom[int](a1, comparator.ComparatorInt)
	...
	gtest.C(t, func(t *gtest.T) {
		a1 := []int{1, 2, 3, 4, 5, 6}
		array1 := garray.NewSortedArrayFrom(a1, comparator.ComparatorInt)
...
func TestSortedArray_Rand(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array2 := garray.NewSortedArrayFrom([]string{}, func1)
		v, ok := array2.Rand()
		t.Assert(ok, false)
		t.Assert(v, nil)
	})
...
func TestSortedArray_Join(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		a1 := []string{}
		array1 := garray.NewSortedArrayFrom(a1, comparator.ComparatorString)
...
func TestSortedArray_Unique(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array2 := garray.NewSortedArrayFrom([]int{}, comparator.ComparatorInt)
		array2.Unique()
...
func TestSortedArray_Merge(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		s4 := garray.NewSortedArrayFrom([]string{"4", "5"}, comparator.ComparatorString)
		s5 := garray.NewSortedArrayFrom(s2, comparator.ComparatorString)
		s6 := garray.NewSortedArrayFrom([]string{"1", "2", "3"}, comparator.ComparatorString)

		a1 := garray.NewSortedArrayFrom(s1, comparator.ComparatorString)
...
func TestSortedArray_Json(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		a2 := garray.NewSortedArray(comparator.ComparatorString)
		err1 = json.UnmarshalUseNumber(b2, &a2)
		t.AssertNil(err1)
		t.Assert(a2.Slice(), s2)

		var a3 garray.SortedArray[string]
...
func TestSortedArray_Iterator(t *testing.T) {
	...
	array := garray.NewSortedArrayFrom(slice, comparator.ComparatorString)
	gtest.C(t, func(t *gtest.T) {
...
func TestSortedArray_UnmarshalValue(t *testing.T) {
	type V struct {
		Name  string
		Array *garray.SortedArray[byte]
	}
	type VInt struct {
		Name  string
		Array *garray.SortedArray[int]
	}
	// JSON
	gtest.C(t, func(t *gtest.T) {
		var v *V
...
func TestSortedArray_Filter(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array := garray.NewSortedArrayFromCopy[*exampleElement](values, comparatorExampleElement)
...
func TestSortedArray_Walk(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := garray.NewSortedArrayFrom([]string{"1", "2"}, comparator.ComparatorString)
...
func TestSortedArray_IsEmpty(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := garray.NewSortedArrayFrom([]string{}, comparator.ComparatorString)
...
func TestSortedArray_DeepCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		array := garray.NewSortedArrayFrom([]int{1, 2, 3, 4, 5}, comparator.ComparatorInt)
		copyArray := array.DeepCopy().(*garray.SortedArray[int])
		array.Add(6)
		copyArray.Add(7)
