...
func ExampleArray_Reverse() {
	array := garray.NewFrom[int]([]int{1, 2, 3, 4, 5, 6, 7, 8, 9})
...
func ExampleArray_Join() {
	array := garray.NewFrom[string]([]string{"a", "b", "c", "d"})
...
func ExampleArray_Merge() {
	array1 := garray.NewFrom[int]([]int{1, 2})
	array2 := garray.NewFrom[int]([]int{3, 4})
	slice1 := []int{5, 6}
	slice2 := []int{7, 8}
	slice3 := []int{9, 0}
...
func ExampleArray_Filter() {
	array1 := garray.NewFrom[*exampleElement]([]*exampleElement{
		{code: 0},
		{code: 1},
		{code: 2},
		nil,
	...
	array2 := garray.NewFrom[*exampleElement]([]*exampleElement{
		{code: 0},
		{code: 1},
		{code: 2},
		nil,
