...
func Test_Array_Var(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		var array garray.SortedArray[int]
	...
	gtest.C(t, func(t *gtest.T) {
		var array garray.SortedArray[string]
...
func Test_SortedStrArray1(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		array1 := garray.NewSortedArray[string](comparator.ComparatorString)
		array2 := garray.NewSortedArray[string](comparator.ComparatorString, true)
		for i := 10; i > -1; i-- {
...
func Test_SortedStrArray2(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		expect := []string{"0", "1", "10", "2", "3", "4", "5", "6", "7", "8", "9"}
		array := garray.NewSortedArray[string](comparator.ComparatorString)
		for i := 0; i <= 10; i++ {
...
func Test_SortedArray1(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		expect := []string{"0", "1", "10", "2", "3", "4", "5", "6", "7", "8", "9"}
		array := garray.NewSortedArray(comparator.ComparatorString)
		for i := 10; i > -1; i-- {
			array.Add(gconv.String(i))
		}
		t.Assert(array.Slice(), expect)
