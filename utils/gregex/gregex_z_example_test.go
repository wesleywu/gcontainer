...
import (
	...
	"github.com/wesleywu/gcontainer/utils/gutil"
)

func ExampleIsMatch() {
	patternStr := `\d+`
	gutil.Dump(gregex.IsMatch(patternStr, []byte("hello 2022! hello gf!")))
	gutil.Dump(gregex.IsMatch(patternStr, nil))
	gutil.Dump(gregex.IsMatch(patternStr, []byte("hello gf!")))
...
func ExampleIsMatchString() {
	patternStr := `\d+`
	gutil.Dump(gregex.IsMatchString(patternStr, "hello 2022! hello gf!"))
	gutil.Dump(gregex.IsMatchString(patternStr, "hello gf!"))
	gutil.Dump(gregex.IsMatchString(patternStr, ""))
